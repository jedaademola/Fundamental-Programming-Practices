...
public class ComputerDeepCopy implements Cloneable {
	
	
	public Object clone() throws CloneNotSupportedException {

		ComputerDeepCopy clone=(ComputerDeepCopy)super.clone();
		return clone;
 }
	...
	public ComputerDeepCopy(String manufacturer, String processor, int ramSize, int diskSize, double processorSpeed) {
